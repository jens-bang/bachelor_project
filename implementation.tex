...
Since this was a blackbox-implementation scheme, it can be assumed that the programmer has no knowledge about the theory behind the model. The initial code analysis was done and gave an overview of the variables and procedures. To perform an 
...
\begin{table}[htb]
	...
	\begin{tabular}{llp{6cm}}
		...
		BOUND 			& $nx\times ny$ (binary) 		& boundary defined by 1's\\
	...
	\end{tabular}
	\label{matlabvars}
	\caption{Variables and their usage in the Matlab version of D2Q9 LBM}
\end{table}
