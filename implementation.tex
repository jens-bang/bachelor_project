...
\subparagraph{Propagation} Propagation is where nodes densities are spread outward to affect neighbouring nodes. In the Matlab code this happens in line 44-54 in \hpref{listing}{lbmmatlab}. Lets examine line 45 and see how this is done
