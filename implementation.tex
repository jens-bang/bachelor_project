...
\insfig{./images/pycudaworkflow.eps}{1.0\textwidth}{pycuda workflow}{pcwork}
...
\hspace{1pt}
\subfigure[NumPy]{
\includegraphics[width=0.30\textwidth]{./images/numpyControl.png}
\label{corectness:b}
}
\subfigure[PyCUDA]{
\includegraphics[width=0.30\textwidth]{./images/pycudaControl.png}
\label{corectness:c}
}
\caption{corectness}
\label{correctness}
