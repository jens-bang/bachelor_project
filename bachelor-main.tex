...
The two Python implementations of the Lattice Boltzmann Model are both based on a MatLab implementation of the model, which will be introduced in the Implementation section of this paper. [TODO Kan man automatisk indsætte den korrekte titel på afsnittet?]
