...
\insfig{./images/cpu-vs-gpu.png}{0.7\textwidth}{Visualization of the amount of a CPU devoted to data processing as compared to a GPU (inspired by \cite{bestpracticesguide} figure 1-2 p. 3).}{cpuvsgpu}
