...
CUDA exposes more than just one memory model to the programmer, each with their different purpose and performance. \hpref{Figure}{cudamem} shows the different types of memory. In \hpref{table}{cudamemtable} the different memory types are listed.
